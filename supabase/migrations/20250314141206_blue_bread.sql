/*
  ...
  1. Changes
    - Add sample payments for demo user
...
(
  ...
  'Personal Training - Late Payment',
  'INV-2025-004',
  'Personal Training'
),
(
...
(
  ...
  'Personal Training - Bank Transfer',
  'INV-2025-006',
  'Personal Training'
),
(
  ...
  'Personal Training - Cash Payment',
  'INV-2025-007',
  'Personal Training'
),
(
  ...
  NOW() - INTERVAL '35 days',
  NOW() - INTERVAL '40 days',
  'Personal Training - Card Payment',
  'INV-2025-008',
  'Personal Training'
),
...
(
  ...
  'Personal Training - Premium Package',
  'INV-2025-010',
  'Personal Training'
),
(
  ...
  'Personal Training - Elite Package',
  'INV-2025-011',
  'Personal Training'
),
