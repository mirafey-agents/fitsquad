...
const FEATURED_JOURNEYS = [
  {
    ...
    trainer: 'Sarah Chen',
    isVerified: true,
    trainerBio: 'Elite Marathon Coach | Boston Marathon Finisher | 10+ Years Experience',
  ...
  },
  {
    ...
    trainer: 'Mike Ross',
    isVerified: false,
    trainerBio: 'Certified Physiotherapist | Specializing in Posture Correction',
...
const GROUP_CLASSES = [
  {
    ...
    tags: ['Yoga', 'Morning', 'Studio Class'],
  },
  {
    id: '6',
    type: 'online',
    ...
    tags: ['HIIT', 'Strength', 'Online Live'],
  },
];
                ...
                <View style={styles.featuredContent}>
                  <View style={styles.featuredHeader}>
                    <View style={styles.trainerInfo}>
                      ...
                      <Pressable 
                        style={styles.trainerNameContainer}
                        onPress={() => router.push(`/trainer/${journey.trainer.toLowerCase().replace(' ', '-')}`)}
                      >
                        ...
                        <Text style={styles.trainerBio} numberOfLines={1}>{journey.trainerBio}</Text>
                      </Pressable>
                    </View>
                ...
                <View style={styles.classContent}>
                  <View style={styles.classHeader}>
                    <BlurView intensity={80} style={[
                      styles.classTypeTag,
                      classItem.type === 'physical' ? styles.physicalTag : styles.onlineTag
                    ]}>
                      <Ionicons 
                        name={classItem.type === 'physical' ? 'location' : 'globe'} 
                        size={14} 
                        color={classItem.type === 'physical' ? colors.semantic.warning : colors.semantic.info} 
                      />
                      <Text style={[
                        styles.classTypeText,
                        classItem.type === 'physical' ? styles.physicalText : styles.onlineText
                      ]}>
                        {classItem.type === 'physical' ? 'Studio Class' : 'Online Live'}
                      </Text>
                    </BlurView>
